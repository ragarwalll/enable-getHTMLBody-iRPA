...
<ConteXtorStudio Version="Desktop Studio 2.0.0.173" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" noNamespaceSchemaLocation="XsdStudio.xsd">
	<UpdatePackages />
	<Evolutions>
		<Evolution Version="1.0" Date="28-Jul-20"><![CDATA[Project creation]]></Evolution>
		<Evolution Version="..." Date="..."><![CDATA[...]]></Evolution>
	</Evolutions>
	<PROCESSUS>
		<PROCESS Name="GLOBAL" Key="NoKey" Comment="Global Processus" CtxtId="380e02fc-8c72-4e72-bcc3-1d4e13c83f0d">
			<_DECLAREVAR>
				<STRUCTUREDON Name="GLOBAL">
					<OBJDON Name="PrjVersion">1.0</OBJDON>
					<OBJDON Name="PrjClient"><![CDATA[SAP]]></OBJDON>
					<OBJDON Name="PrjName">enable-getHTMLBody-iRPA</OBJDON>
					<OBJDON Name="PrjDate">28-Jul-20</OBJDON>
					<OBJDON Name="PrjLabel"><![CDATA[enable-getHTMLBody]]></OBJDON>
			...
			<SCRIPTS>
				...
				<SCRIPT Name="Declarations" Src="enable-gethtmlbody-irpa.resources.js" ReadOnly="Y" />
				<SCRIPT Name="Labels" Src="labels.js" />
				<SCRIPT Name="Global" Src="global.js" />
				<SCRIPT Name="outlook" Src="outlook.js" />
				<SCRIPT Name="EmailWorflow" Src="emailworflow.js" IsWorkflowGenerated="Y" />
			</SCRIPTS>
			<RESOURCES>
			...
			<WORKFLOWS>
				<WORKFLOW Name="EmailWorflow" Src="%workflows%\EmailWorflow.xaml" CtxtId="3fd57d99-6ace-49a0-8bf3-afd7ce732568" DisplayName="EmailWorflow" StepTimeout="30" ScenarioTimeout="600" GeneratedScenarioName="EmailWorflow" />
			</WORKFLOWS>
		</PROCESS>
		<PROCESS Name="POPUPS" CtxtId="9a1105c2-7363-4bec-ba08-52fe57477caf" Nature="POPUP">
			<SCRIPTS />
			<SCENARII>
				<Steps />
			</SCENARII>
	...
	<APPLICATIONS />
	<CONTEXT Id="74b04e1f-4e3a-4d9d-852d-3dd3707660da" />
</ConteXtorStudio>